...
test_that("Handles datasets with varying column names for date and match.", {
  d_matches_varnames <- tribble(
    ~training_date, ~match_indicator,
    "2017-08-22", 0,
    "2017-08-23", 1,
    "2017-08-24", 0,
    "2017-08-25", 0,
  ...
  expect_equal(
    add_event_id(d_matches_varnames, training_date, match_indicator)$event_id,
    add_event_id(d_matches_sim, date, match)$event_id
  )
})

test_that("Returns error at incorrect datatypes.", {
  d_matches_datesasstrings <- tribble(
    ~date, ~match,
    "2017-08-22", 0,
    "2017-08-23", 1,
    "2017-08-24", 0
